...
export default function NavSection() {
  return (
    <nav className="fixed z-50 flex flex-row lg:flex-col w-full lg:w-1/4 lg:h-full p-4 px-8 lg:px-0 lg:pl-20 bg-neutral lg:bg-neutral/70 text-neutral-content max-w-full lg:max-w-xs">
      <h1 className="text-3xl font-semibold tracking-tight grow lg:grow-0">
        Juan Ramirez
      </h1>
